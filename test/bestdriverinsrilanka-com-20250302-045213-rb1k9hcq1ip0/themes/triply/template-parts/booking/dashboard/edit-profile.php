                        ...
                        <div class="checkout-form-block edit-profile-form-block">
                            <div class="checkout_form_input_field <?php echo esc_attr($add_content_class); ?>">
                                ...
                                if ($field_name == 'username') : ?>
                                    <label class="checkout_form_input_label"><?php echo esc_html__('User name', 'triply') ?></label>
                                    <input readonly type="text" class="checkout_input_field checkout_input_required edit_profile_input_field edit_profile_input_required" name="<?php echo esc_attr($field_name); ?>" id="<?php echo esc_attr($field_name); ?>" value="<?php echo esc_attr($field_content) ?>" <?php echo apply_filters('babe_checkout_field_required', '', $field_name); ?>/>

                                <?php else : ?>
                                    <label class="checkout_form_input_label"><?php echo esc_html(BABE_html::checkout_field_label($field_name)) ?></label>
                                    <input type="text" class="checkout_input_field checkout_input_required edit_profile_input_field edit_profile_input_required" name="<?php echo esc_attr($field_name); ?>" id="<?php echo esc_attr($field_name); ?>" value="<?php echo esc_attr($field_content) ?>" <?php echo apply_filters('babe_checkout_field_required', '', $field_name); ?>/>

                                <?php endif; ?>
                                <div class="checkout_form_input_underline">
                                    <span class="checkout_form_input_ripple"></span></div>
                            </div>
                            <?php
                            if ($field_name == 'username') {
